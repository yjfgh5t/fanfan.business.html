<template>
  <div class="body" style="height: 100%">
    ...
    <mt-cell title="店铺Logo" class="mint-field" >
      <img class="img" :src="itemModel.logo" v-on:click="imgActionsVisible=true" />
    </mt-cell>
    ...
    <mt-field label="店铺地址" placeholder="请输入店铺地址"  type="textarea" rows="2" length="128" v-model="itemModel.desc"></mt-field>
    <!-- 选择相册或拍照-->
